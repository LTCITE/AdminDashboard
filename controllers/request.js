...
api.all('/', function (req, res) {
    ...
    var options2 = {
        host: 'nwmissouri.instructure.com',
        path: '/api/v1/accounts/1/sis_imports?access_token=7438~tdwOQXjcnESRM9cfQ9q0ZjPu9Cnsxxib472LHZ2hCe3aRzuNYRjLIZ5rN10MqmLA'
...
var recordCount = {
            ...
            for (var i = 0; i < json_data.sis_imports.length; i++) {
                if (json_data.sis_imports[i].workflow_state === "imported_with_messages") {
                    var api_key = 'key-5a6bdd0595cbde95463a50e9a1aa3dfb';
                    var domain = 'sandbox5bab74a21d8b456c94011e161b058a0a.mailgun.org';
                    var mailgun = require('mailgun-js')({ apiKey: api_key, domain: domain });
                    var data = {
                        from: 'SIS import dashboard <postmaster@sandbox5bab74a21d8b456c94011e161b058a0a.mailgun.org>',
                        to: 'dasarshmanikonda@gmail.com',
                        subject: 'Warnings !',
